...
class BookTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format(
            "postgres", "#Datascience1", "localhost:5432", self.database_name
        )
...
#---------------------------------------------------------------------------------------------
#               A FUNCTION WITH A CLEAR DESCRIPTION THAT WE WANNA TEST
#------------------------------------------------------------------------------------------
    ...
    #-------------------------------------------------------------------------------------------
    #        TEST THAT A 404 IS SENT IF REQUESTING BEYOND A VALID PAGE
    # ------------------------------------------------------------------------------------------
