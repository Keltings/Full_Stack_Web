...
#------------------------------------------------------------------------
#FUNCTION TO TAKE THE REQUEST AND SELECTION THEN DISPLAY NUMBRE OF BOOKS PER PAGE
#-------------------------------------------------------------------------
...
def create_app(test_config=None):
    ...
    #----------------------------------------------------------------------------
    #           THE PATCH REQUEST TO UPDATE A SINGLE BOOK RATING
    #-----------------------------------------------------------------------------
    ...
    def update_book(book_id):
        ...
        try:
            # find the book
            book = book.query.flter(Book.id == book_id).one_or_none()
            if book is None:
                abort(404)
    ...
    #we want to post to the whole collection
